...
SCRIPT_DIRECTORY = MODEL_ROOT  # Kept for compatibility with older imports.
MODEL_DIRECTORY = MODEL_ROOT / "model"
TRAINING_DATA_DIRECTORY = MODEL_ROOT / "data" / "training"
SIMULATION_DATA_DIRECTORY = MODEL_ROOT / "data" / "simulation"
CACHE_DIRECTORY = MODEL_ROOT / "data" / "cache" / "rl3_cache"
STRATEGY_REVISION = 2
MODEL_PATH = MODEL_DIRECTORY / "rl_codex_3_portfolio_policy_v2"
METADATA_PATH = MODEL_DIRECTORY / "RL_CODEX_3_METADATA_V2.json"
WALK_FORWARD_PATH = TRAINING_DATA_DIRECTORY / "RL_CODEX_3_WALK_FORWARD_V2.csv"
DATA_QUALITY_PATH = TRAINING_DATA_DIRECTORY / "RL_CODEX_3_DATA_QUALITY_V2.json"
FINAL_CHECKPOINT_PATH = MODEL_DIRECTORY / "rl_codex_3_v2_final_checkpoint"
FINAL_CHECKPOINT_METADATA_PATH = (
    MODEL_DIRECTORY / "RL_CODEX_3_V2_FINAL_CHECKPOINT.json"
)
