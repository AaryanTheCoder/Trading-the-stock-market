...
TRADE_LOG_PATH = SIMULATION_DATA_DIRECTORY / "CODEX_SIMULATION_3_V2_TRADES.csv"
EQUITY_PATH = SIMULATION_DATA_DIRECTORY / "CODEX_SIMULATION_3_V2_EQUITY.csv"
HOLDINGS_PATH = SIMULATION_DATA_DIRECTORY / "CODEX_SIMULATION_3_V2_FINAL_HOLDINGS.csv"
SUMMARY_PATH = SIMULATION_DATA_DIRECTORY / "CODEX_SIMULATION_3_V2_SUMMARY.json"
SIMULATION_DATA_QUALITY_PATH = (
    SIMULATION_DATA_DIRECTORY / "CODEX_SIMULATION_3_V2_DATA_QUALITY.json"
)
PAPER_DIRECTORY = SIMULATION_DATA_DIRECTORY / "paper_signals"
...
def main() -> None:
    SIMULATION_DATA_DIRECTORY.mkdir(parents=True, exist_ok=True)
