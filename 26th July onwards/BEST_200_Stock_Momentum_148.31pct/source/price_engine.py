"""Price engine for the isolated 200-stock Gemini news-overlay experiment.
...
WORK_DIR = MODEL_ROOT  # Backward-compatible name used by older callers.
REPO_ROOT = MODEL_ROOT.parents[1]
MODEL_ARTIFACT_DIR = MODEL_ROOT / "model"
TRAINING_DATA_DIR = MODEL_ROOT / "data" / "training"
SIMULATION_DATA_DIR = MODEL_ROOT / "data" / "simulation"
TRADES_DATA_DIR = SIMULATION_DATA_DIR / "trades"
CACHE_DATA_DIR = MODEL_ROOT / "data" / "cache"
# The 200 historical price files needed by this model are stored here, so this
# package can run without reading a different model's folder.
SOURCE_PRICE_DIR = CACHE_DATA_DIR / "base_prices"
LOCAL_PRICE_DIR = CACHE_DATA_DIR / "latest_prices"
